...
import { AcuMobCom, turnOnSpeaker, deleteSpaces } from 'react-native-aculab-client';
  ...
  return (
    <View style={styles.callButtonsContainer}>
      ...
      <CallButton
        ...
        onPress={() =>
          props.acuMobCom.setState({ speakerOn: !props.acuMobCom.state.speakerOn }, () =>
  ...
  return (
    <View style={styles.dialKeypad}>
      ...
      props.acuMobCom.state.callState === 'ringing' ? (
        <View>
          <Text style={styles.callingText}>Calling {props.acuMobCom.state.serviceName}</Text>
        </View>
      ) : (
        <View>
          <Text style={styles.callingText}>Service {props.acuMobCom.state.serviceName}</Text>
        </View>
      )}
      <View>
        <View style={styles.callButtonsContainer}>
          <KeypadButton title={'1'} onPress={() => props.acuMobCom.sendDtmf('1')} />
          <KeypadButton title={'2'} onPress={() => props.acuMobCom.sendDtmf('2')} />
          <KeypadButton title={'3'} onPress={() => props.acuMobCom.sendDtmf('3')} />
        </View>
        <View style={styles.callButtonsContainer}>
          <KeypadButton title={'4'} onPress={() => props.acuMobCom.sendDtmf('4')} />
          <KeypadButton title={'5'} onPress={() => props.acuMobCom.sendDtmf('5')} />
          <KeypadButton title={'6'} onPress={() => props.acuMobCom.sendDtmf('6')} />
        </View>
        <View style={styles.callButtonsContainer}>
          <KeypadButton title={'7'} onPress={() => props.acuMobCom.sendDtmf('7')} />
          <KeypadButton title={'8'} onPress={() => props.acuMobCom.sendDtmf('8')} />
          <KeypadButton title={'9'} onPress={() => props.acuMobCom.sendDtmf('9')} />
        </View>
        <View style={styles.callButtonsContainer}>
          <KeypadButton title={'*'} onPress={() => props.acuMobCom.sendDtmf('*')} />
          <KeypadButton title={'0'} onPress={() => props.acuMobCom.sendDtmf('0')} />
          <KeypadButton title={'#'} onPress={() => props.acuMobCom.sendDtmf('#')} />
        </View>
      </View>
    </View>
...
const ButtonsIncoming = (props: any) => {
  return (
    <View style={styles.callButtonsContainer}>
      <CallButton title={'Reject'} colour={COLOURS.RED} onPress={() => props.acuMobCom.reject()} />
      <CallButton
        title={'Accept'}
...
const ClientCallButtons = (props: any) => {
  ...
  return (
    <View style={styles.callButtonsContainer}>
      <RoundButton iconName={'camera-reverse-outline'} onPress={() => props.acuMobCom.swapCam()} />
      <RoundButton
        iconName={videoIcon}
        onPress={() =>
          props.acuMobCom.setState({ camera: !props.acuMobCom.state.camera }, () =>
  ...
  return (
    <View style={styles.inputContainer}>
      <View>
        ...
        />
        <MenuButton title={'Call Service'} onPress={() => props.acuMobCom.callService()} />
      </View>
      <View>
        ...
        />
        <MenuButton title={'Call Client'} onPress={() => props.acuMobCom.callClient()} />
      </View>
    </View>
  );
};
    ...
    if (
      ...
      return (
        <View style={styles.center}>
          <Text style={styles.callingText}>Calling {props.acuMobCom.state.callClientId}</Text>
        </View>
      );
    } else {
      return (
        <View style={styles.center}>
          <Text style={styles.callingText}>{props.acuMobCom.state.callClientId}</Text>
        </View>
      );
    }
  } else {
    if (props.acuMobCom.state.localVideoMuted && !props.acuMobCom.state.remoteVideoMuted) {
      return (
        <View style={styles.vidview}>
          <RTCView streamURL={props.acuMobCom.state.remoteStream.toURL()} style={styles.rtcview} />
        </View>
      );
    } else if (props.acuMobCom.state.remoteVideoMuted && !props.acuMobCom.state.localVideoMuted) {
      return (
        <View style={styles.vidview}>
          <Image
  ...
  if (props.acuMobCom.state.callState === 'incoming call') {
    return (
      <View style={styles.center}>
        ...
        <Text style={styles.callingText}>{props.acuMobCom.state.incomingCallClientId}</Text>
      </View>
    );
